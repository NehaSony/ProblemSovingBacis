...
public class LeftView {
    ...
    private int countLeftViewNode(Node root){
        int count = 0;
        ...
        while(!bfs.isEmpty()){
            for(int i = 0; i<bfs.size(); i++){
                ...
                if(i==0) count++;
                if(current.left!=null) bfs.offer(current.left);
                if(current.right!=null) bfs.offer(current.right);
            }
        }
        return count;
    }
